...
import ModalAddNewGroup from './ModalAddNewSewingLineDelivery'
...
const SewingLineDeliveryTable: React.FC<Props> = ({ ...props }) => {
  ...
  } = useTable<SewingLineDeliveryTableDataType>([])

  console.log('SewingLineDeliveryTable...')
  ...
  const actionsCols: (ColumnTypes[number] & {
  ...
  })[] = [
    {
      ...
      width: '15%',
      dataIndex: 'operation',
      render: (_, record: SewingLineDeliveryTableDataType) => {
            ...
            handleAddNew(_form, (meta) => {
              if (meta.success) {
                ...
                const itemNew = {
                  key: data.id!,
                  ...data
                } as TableDataType<SewingLineDeliveryTableDataType>
